...
<p className="font-extrabold font-sans tracking-wide sm:pt-20 text-3xl  sm:text-4xl  text-center sm:text-center ">ABOUT US</p>

<p className="border-4 border-purple-700  w-10  rounded-lg"></p></div>
<div className="text-center pt-8">
<P1 className=" sm:font-bold text-center sm:text-lg  ">Here you will find more information about us!</P1>
</div></div>
